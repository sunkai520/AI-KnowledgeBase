...
import { generateImageFromText, generateVideoFromImage } from "./mediaProvider";
...
export const generateVideoFromImageTool = tool(
  ...
  },
  {
    ...
    description:
      ...
      "不要每段都重新 generate_image（会导致每段角色长相不一致），" +
      "应该用 extract_video_last_frame 取上一段视频的最后一帧作为这一段的输入图片，保证动作连续不跳变。" +
